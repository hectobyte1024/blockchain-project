...
CREATE INDEX IF NOT EXISTS idx_utxos_address ON utxos(address, is_spent);
...
CREATE INDEX IF NOT EXISTS idx_loans_id ON loan_applications(loan_id);
CREATE INDEX IF NOT EXISTS idx_loans_applicant ON loan_applications(applicant_address);
...
CREATE INDEX IF NOT EXISTS idx_loan_funders_loan ON loan_funders(loan_id);
CREATE INDEX IF NOT EXISTS idx_loan_funders_funder ON loan_funders(funder_address);
